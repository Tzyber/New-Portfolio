    ...
    <div class="flex flex-col gap-8 lg:gap-16 mb-16">
      <div class="flex flex-col gap-8">
        ...
        <div>
          ...
          <span class="text-white text-sm md:text-base leading-relaxed">
         One aspect of my job that I particularly enjoy is web design. I find the process of designing visually appealing and functional websites to be both creatively fulfilling and intellectually challenging.</span>
        </div>
        <div class="border-b border-amber-300 transition-transform"></div>
        <div>
          <h1 class="text-xl justify-center sm:text-3xl text-white md:text-4xl md:leading-normal slg:text-5xl slg:leading-relaxed font-theme_bold text-head_text">
            Tooling:
          </h1>
          <span class="text-white text-sm md:text-base leading-relaxed">
        Working with VueJs, Webstorm, Git, Javascript, Typescript, CSS, SCSS, Tailwind</span>
        </div>
      </div>
    </div>
  </div>
